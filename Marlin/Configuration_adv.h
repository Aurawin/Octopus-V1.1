 ...
 */
  ...
  #define PID_FAN_SCALING
    ...
    //#define PID_FAN_SCALING_ALTERNATIVE_DEFINITION
      ...
      #define PID_FAN_SCALING_MIN_SPEED 25               // Minimum fan speed at which to enable PID_FAN_SCALING
    #endif
  #endif
#endif
...
#define SENSORLESS_BACKOFF_MM  { 0, 0, 7 }  // (mm) Backoff from endstops before sensorless homing

#define HOMING_BUMP_MM      { 0, 0, 7 }       // (mm) Backoff from endstops after first bump
...
#define Z_STEPPER_AUTO_ALIGN
 ...
 /**
  ...
  #define G34_MAX_GRADE              7    // (%) Maximum incline that G34 will handle
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 150*60, 150*60, 12*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        1200  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     1200  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         18  // (mm) Length to extrude after loading.
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT        60*15  // (seconds) Time limit before the nozzle is turned off for safety.
 ...
 */
  ...
  #define HOLD_MULTIPLIER_Z  1.0  // Scales down the holding current from run current
  ...
  #define INTERPOLATE      false
    ...
    #define X_HOLD_MULTIPLIER HOLD_MULTIPLIER_XY    // Enable to override 'HOLD_MULTIPLIER' for the X axis
  #endif
    ...
    #define Y_HOLD_MULTIPLIER HOLD_MULTIPLIER_XY
  #endif
